...
[![My Skills](https://skillicons.dev/icons?i=aws,ts,react,vscode,java,dart,git,github,bash,androidstudio,discord,figma,firebase,githubactions,powershell)](https://skillicons.dev)
